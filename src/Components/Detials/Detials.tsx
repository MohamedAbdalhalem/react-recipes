    ...
    <div className="h-full px-3 py-4  bg-gray-100 ">
          ...
          <div className='sm:ml-64'>
            <div className='p-4 container bg-gray-200'>
                ...
                <a href={data?.data.meals[0].strYoutube}  className='text-white cursor-pointer bg-red-600 py-2 px-5 rounded-2xl'><i className='fa-brands fa-youtube me-2 align-baseline'></i>you tube</a>
                        <a href={data?.data.meals[0].strSource}  className='text-white cursor-pointer bg-green-600 py-2 px-5 rounded-2xl'><i className='fa-solid fa-earth me-2 align-baseline'></i>source</a>
                        </div>
                    </div>
                    <div>
